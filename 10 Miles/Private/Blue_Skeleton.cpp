#include "stdafx.h"
#include "..\Public\Blue_Skeleton.h"
#include "GameInstance.h"
#include<ctime>
#include "SoundMgr.h"
#include "EventMgr.h"

CBlue_Skeleton::CBlue_Skeleton(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CBlendObject(pGraphic_Device)
{
}

CBlue_Skeleton::CBlue_Skeleton(const CBlue_Skeleton & rhs)
	: CBlendObject(rhs)

{
}

HRESULT CBlue_Skeleton::NativeConstruct_Prototype()
{
...
HRESULT CBlue_Skeleton::NativeConstruct(void * pArg)
{
...
_int CBlue_Skeleton::Tick(_float fTimeDelta)
{
	if (true == m_bDead)
		return 1;
...
void CBlue_Skeleton::LateTick(_float fTimeDelta)
{
...
HRESULT CBlue_Skeleton::SetUp_Components()
{
	/* For.Com_Transform */
	...
	/* For.Com_Texture */
  	if (FAILED(__super::SetUp_Components(TEXT("Com_Texture"), m_Current_Level, TEXT("Prototype_Component_Texture_Blue_skeleton"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;

	CStatus::STATUSDESC		StatusmDesc;
	ZeroMemory(&StatusmDesc, sizeof(CStatus::STATUSDESC));
	StatusmDesc.fMaxHp = 50.f;
	...
	for (int i = 0; i < 10; ++i)
	{
		...
		if (FAILED(__super::SetUp_Components(szPath4[i], m_Current_Level, TEXT("Prototype_Component_Texture_Blue_skeleton"), (CComponent**)&m_CubeTT)))
			return E_FAIL;
...
HRESULT CBlue_Skeleton::SetUp_OnTerrain()
{
	CGameInstance*			pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
void CBlue_Skeleton::Set_Part(int Part, int Local, _float3 Pos)
{
	_float4x4	MX;
...
void CBlue_Skeleton::Set_Part2(int Part, _float3 Pos)
{
	_float4x4	MX;
	D3DXMatrixIdentity(&MX);
...
void CBlue_Skeleton::Attack(_float fTimeDelta)
{
...
void CBlue_Skeleton::Falling(_float fTimeDelta)
{
...
*/
void CBlue_Skeleton::Down(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CBlue_Skeleton::Up(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CBlue_Skeleton::find(_float fTimeDelta)
{
...
void CBlue_Skeleton::Crawl(_float fTimeDelta)
{
	//움직이는 속도
...
void CBlue_Skeleton::Walk(_float fTimeDelta)
{
	//움직이는 속도
...
void CBlue_Skeleton::Move(_float fTimeDelta)
{
	//움직이는 속도
	_float3 RH = _float3(-0.0015f, 0.01f, 0.01f);
	_float3 LH = _float3(0.0015f, 0.01f, 0.01f);
...
void CBlue_Skeleton::Stay(_float fTimeDelta)
{
...
CBlue_Skeleton * CBlue_Skeleton::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CBlue_Skeleton*	pInstance = new CBlue_Skeleton(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CBlue_Skeleton"));
...
CGameObject * CBlue_Skeleton::Clone(void * pArg)
{
	CBlue_Skeleton*	pInstance = new CBlue_Skeleton(*this);
