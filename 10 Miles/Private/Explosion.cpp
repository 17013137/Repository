...
HRESULT CExplosion::SetUp_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Texture"), m_Current_Level, TEXT("Prototype_Component_Texture_Explosion"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
	m_pTransformCom->Scaled(_float3(7.f, 4.f, 1.f));
