...
CSteve_Dummy::CSteve_Dummy(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CSteve_Dummy::CSteve_Dummy(const CSteve_Dummy & rhs)
	: CGameObject(rhs)

{
}

HRESULT CSteve_Dummy::NativeConstruct_Prototype()
{
...
HRESULT CSteve_Dummy::NativeConstruct(void * pArg)
{
...
_int CSteve_Dummy::Tick(_float fTimeDelta)
{
...
void CSteve_Dummy::LateTick(_float fTimeDelta)
{
...
HRESULT CSteve_Dummy::Render()
{
	...
	for (int i = 0; i < 8; ++i)
	{
		...
		if (FAILED(m_vTT[i]->Bind_OnGraphicDevice(i+18)))
			return E_FAIL;
...
HRESULT CSteve_Dummy::SetUp_Components()
{
	/* For.Com_Transform */
...
HRESULT CSteve_Dummy::SetUp_OnTerrain()
{
	CGameInstance*			pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
void CSteve_Dummy::Set_Part(int Part, int Local, _float3 Pos)
{
	_float4x4	MX;
...
void CSteve_Dummy::Set_Part2(CSubTransform* Part, _float3 Pos)
{
	_float4x4	MX;
	D3DXMatrixIdentity(&MX);
...
void CSteve_Dummy::Run(_float fTimeDelta)
{
	//움직이는 속도
...
void CSteve_Dummy::Walk(_float fTimeDelta)
{
	//움직이는 속도
...
void CSteve_Dummy::Falling(_float fTimeDelta)
{
...
void CSteve_Dummy::Down(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CSteve_Dummy::Up(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CSteve_Dummy::NO(_float fTimeDelta)
{
...
void CSteve_Dummy::YES(_float fTimeDelta)
{
	_float3 RH = _float3(0.f, 0.6f, 0.6f)*fTimeDelta;
...
void CSteve_Dummy::FOLDED(_float fTimeDelta)
{
...
void CSteve_Dummy::HI(_float fTimeDelta)
{
...
void CSteve_Dummy::Stay(_float fTimeDelta)
{
...
int CSteve_Dummy::ActionMoving(_float fTimeDelta)
{
	if (CEventMgr::Get_Instance()->Get_OnAir() == false)
		return 0;

	//if (CEventMgr::Get_Instance()->Get_EventCnt() == 5 && CEventMgr::Get_Instance()->Get_isInitSet(3) == true && flag == false) {
	//	NO(fTimeDelta);
	//	return 1;
	//}
...
void CSteve_Dummy::Attack(_float fTimeDelta)
{
...
CSteve_Dummy * CSteve_Dummy::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CSteve_Dummy*	pInstance = new CSteve_Dummy(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CSteve_Dummy"));
...
CGameObject * CSteve_Dummy::Clone(void * pArg)
{
	CSteve_Dummy*	pInstance = new CSteve_Dummy(*this);
