...
_int CSkeleton::Tick(_float fTimeDelta)
{
	if (true == m_bDead)
		return 1;
...
void CSkeleton::LateTick(_float fTimeDelta)
{
...
HRESULT CSkeleton::SetUp_Components()
{
	/* For.Com_Transform */
	...
	for (int i = 0; i < 10; ++i)
	{
		...
		if (FAILED(__super::SetUp_Components(szPath4[i], m_Current_Level, TEXT("Prototype_Component_Texture_Skeleton"), (CComponent**)&m_CubeTT)))
			return E_FAIL;
...
void CSkeleton::Set_Part(int Part, int Local, _float3 Pos)
{
	_float4x4	MX;
...
void CSkeleton::Set_Part2(int Part, _float3 Pos)
{
	_float4x4	MX;
	D3DXMatrixIdentity(&MX);
...
void CSkeleton::Attack(_float fTimeDelta)
{
...
void CSkeleton::Falling(_float fTimeDelta)
{
...
*/
void CSkeleton::Down(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CSkeleton::Up(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CSkeleton::find(_float fTimeDelta)
{
...
void CSkeleton::Crawl(_float fTimeDelta)
{
	//움직이는 속도
...
void CSkeleton::Walk(_float fTimeDelta)
{
	//움직이는 속도
...
void CSkeleton::Move(_float fTimeDelta)
{
	//움직이는 속도
	_float3 RH = _float3(-0.0015f, 0.01f, 0.01f);
	_float3 LH = _float3(0.0015f, 0.01f, 0.01f);
...
void CSkeleton::Stay(_float fTimeDelta)
{
...
CSkeleton * CSkeleton::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	...
	{
		MSG_BOX(TEXT("Failed to Created CSkeleton"));
