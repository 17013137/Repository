#include "stdafx.h"
#include "..\Public\Wither_skeleton2.h"
#include "GameInstance.h"
#include<ctime>
#include "SoundMgr.h"
#include "EventMgr.h"

CWither_skeleton2::CWither_skeleton2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CBlendObject(pGraphic_Device)
{
}

CWither_skeleton2::CWither_skeleton2(const CWither_skeleton2 & rhs)
	: CBlendObject(rhs)

{
}

HRESULT CWither_skeleton2::NativeConstruct_Prototype()
{
...
HRESULT CWither_skeleton2::NativeConstruct(void * pArg)
{
...
_int CWither_skeleton2::Tick(_float fTimeDelta)
{
	if (true == m_bDead)
		return 1;
...
void CWither_skeleton2::LateTick(_float fTimeDelta)
{
...
HRESULT CWither_skeleton2::Render()
{
...
HRESULT CWither_skeleton2::SetUp_Components()
{
	/* For.Com_Transform */
...
HRESULT CWither_skeleton2::SetUp_OnTerrain()
{
	CGameInstance*			pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
void CWither_skeleton2::Set_Part(int Part, int Local, _float3 Pos)
{
	_float4x4	MX;
...
void CWither_skeleton2::Set_Part2(int Part, _float3 Pos)
{
	_float4x4	MX;
	D3DXMatrixIdentity(&MX);
...
void CWither_skeleton2::Set_Stay()
{
	_float4x4 i;
...
void CWither_skeleton2::Attack(_float fTimeDelta)
{
...
void CWither_skeleton2::Falling(_float fTimeDelta)
{
...
*/
void CWither_skeleton2::Down(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CWither_skeleton2::Up(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CWither_skeleton2::find(_float fTimeDelta)
{
...
void CWither_skeleton2::Crawl(_float fTimeDelta)
{
	//움직이는 속도
...
void CWither_skeleton2::Walk(_float fTimeDelta)
{
	//움직이는 속도
...
void CWither_skeleton2::Move(_float fTimeDelta)
{
	//움직이는 속도
	_float3 RH = _float3(-0.0015f, 0.01f, 0.01f);
	_float3 LH = _float3(0.0015f, 0.01f, 0.01f);
...
void CWither_skeleton2::Stay(_float fTimeDelta)
{
...
CWither_skeleton2 * CWither_skeleton2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWither_skeleton2*	pInstance = new CWither_skeleton2(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CWither_skeleton2"));
...
CGameObject * CWither_skeleton2::Clone(void * pArg)
{
	CWither_skeleton2*	pInstance = new CWither_skeleton2(*this);
