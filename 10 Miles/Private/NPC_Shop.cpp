...
CNPC_Shop::CNPC_Shop(LPDIRECT3DDEVICE9 pGraphic_Device)
...
_int CNPC_Shop::Tick(_float fTimeDelta)
{
...
void CNPC_Shop::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Shop::SetUp_OnTerrain()
{
	CGameInstance*			pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
void CNPC_Shop::Set_Part(int Part, int Local, _float3 Pos)
{
	_float4x4	MX;
...
void CNPC_Shop::Set_Part2(CSubTransform* Part, _float3 Pos)
{
	_float4x4	MX;
	D3DXMatrixIdentity(&MX);
...
void CNPC_Shop::Run(_float fTimeDelta)
{
	//움직이는 속도
...
void CNPC_Shop::Walk(_float fTimeDelta)
{
	//움직이는 속도
...
void CNPC_Shop::Falling(_float fTimeDelta)
{
...
void CNPC_Shop::Down(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CNPC_Shop::Up(_float fTimeDelta)
{
	_float3 RH = _float3(-0.05f, 0.03f, 0.03f);
	_float3 LH = _float3(0.02f, 0.05, 0.05f);
	_float3 RF = _float3(-0.01f, 0.03f, 0.02f);
...
void CNPC_Shop::Stay(_float fTimeDelta)
{
...
void CNPC_Shop::Attack(_float fTimeDelta)
{
...
CNPC_Shop * CNPC_Shop::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CNPC_Shop*	pInstance = new CNPC_Shop(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNPC_Shop"));
