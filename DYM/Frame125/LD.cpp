...
void LD::Render(HDC hDC)
{
	...
	HBRUSH hbr;
	hbr = CreateSolidBrush(RGB(181, 230, 29));
	HBRUSH hbrold;
...
void LD::Release(void)
{
}

CObj * LD::Create_MonsterBullet(D3DXVECTOR3 _Dir)
{
